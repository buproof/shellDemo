...
export const TERMINAL_NEW_EVENT = "opencode:terminal-new"
export const TERMINAL_OPEN_EVENT = "opencode:terminal-open"
...
export const { use: useTerminal, provider: TerminalProvider } = createSimpleContext({
  ...
  init: () => {
    ...
    window.addEventListener(TERMINAL_NEW_EVENT, handleTerminalNew)
    onCleanup(() => window.removeEventListener(TERMINAL_NEW_EVENT, handleTerminalNew))
