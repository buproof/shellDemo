...
export const dict = {
  ...
  "editor.empty": "打开文件以开始编辑",
  "editor.modified": "已修改",
  "editor.save.button": "保存",
  "editor.save.success": "文件已保存",
  "editor.save.failed": "保存文件失败",
  "editor.save.conflict": "文件已被修改，请重新加载后重试",
  ...
  "session.files.collapseAll": "折叠所有文件夹",
  "common.refresh": "刷新",
