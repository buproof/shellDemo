...
beforeAll(async () => {
  ...
  mock.module("@/lib/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@/lib/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@/lib/ui/icon", () => ({ Icon: () => null }))
  mock.module("@/lib/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
