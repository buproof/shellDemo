...
import { Tooltip, TooltipKeybind } from "@/lib/ui/tooltip"
import { useTheme } from "@/lib/ui/theme/context"
import { IconButtonV2 } from "@/lib/ui/v2/icon-button-v2"
import { Icon as IconV2 } from "@/lib/ui/v2/icon"
import { KeybindV2 } from "@/lib/ui/v2/keybind-v2"
import { TooltipV2 } from "@/lib/ui/v2/tooltip-v2"

import { useLayout, getProjectAvatarVariant, LayoutRoute, type LocalProject } from "@/context/layout"
import { usePlatform } from "@/context/platform"
import { useCommand } from "@/context/command"
import { useLanguage } from "@/context/language"
import { useSettings } from "@/context/settings"
import { DropdownMenu } from "@/lib/ui/dropdown-menu"
import { TERMINAL_NEW_EVENT } from "@/context/terminal"
import { WindowsAppMenu } from "./windows-app-menu"
import { applyPath, backPath, forwardPath } from "./titlebar-history"
import { useServerSync } from "@/context/server-sync"
import { base64Encode } from "@/lib/core-util/encode"
import { ProjectAvatar } from "@/lib/ui/v2/project-avatar-v2"
          ...
          {(_) => {
            ...
            return (
              ...
              >
                ...
                <Show when={!(creating() && params.dir)}>
                  <DropdownMenu>
                    <DropdownMenu.Trigger as={IconButtonV2} type="button" variant="ghost-muted" size="large" class="shrink-0" icon={<IconV2 name="plus" />} aria-label={language.t("command.tab.new")} />
                    <DropdownMenu.Portal>
                      <DropdownMenu.Content class="min-w-[180px]">
                        <DropdownMenu.Item onSelect={() => navigate(newSessionHref())}>
                          <DropdownMenu.ItemLabel>{language.t("command.session.new")}</DropdownMenu.ItemLabel>
                        </DropdownMenu.Item>
                        <DropdownMenu.Item onSelect={() => window.dispatchEvent(new Event(TERMINAL_NEW_EVENT))}>
